...
sample,EGFR,19.75,amplification,"{'LOG2FC':'3.3038333325885','SVTYPE':'<DUP>','SVLEN':'1'}",chr7,55086793,55279321,
sample,IFNA21,0.68,loss,"{'LOG2FC':'-1.55448749878354','SVTYPE':'<DEL>','SVLEN':'1'}",chr9,21165635,21166659,
`);
});
