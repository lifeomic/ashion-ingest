...
{"resourceType":"DiagnosticReport","meta":{"tag":[{"system":"http://lifeomic.com/fhir/dataset","code":"project"},{"code":"LifeOmic Task Service","system":"http://lifeomic.com/fhir/source"},{"code":"Ashion","system":"http://lifeomic.com/fhir/report-source"}]},"status":"final","code":{"text":"Ashion GEM ExTra"},"effectiveDateTime":"2000-01-01","subject":{"reference":"Patient/patient"},"presentedForm":[{"url":"https://api.com/v1/files/1234","contentType":"application/pdf","title":"Ashion GEM ExTra"}]}
`);
  } else {
    t.true(true);
  }
